...
disp ("Running runSpringerSegmentationAlgorithm.m");
...
disp ("classification using boosting");
...
disp ("loop for sample = 1:size(X,1)  ");
% run cnn feedforward
res = nan(size(X,1),2);
